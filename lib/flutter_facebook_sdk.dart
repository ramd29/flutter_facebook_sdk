...
class FlutterFacebookSdk {
  ...
  Future<bool> logViewedContent({required String contentType,
  ...
  Future<bool> logAddToCart({required String contentType,
    required String contentData,
    required String contentId,
    required String currency,
    required double price}) async {
  ...
  Future<bool> logAddToWishlist({required String contentType,
    required String contentData,
    required String contentId,
    required String currency,
    required double price}) async {
  ...
  Future<bool> logPurhcase({required double amount,
    required String currency,
  ...
  Future<bool> logSearch({required String contentType,
    required String contentData,
    required String contentId,
  ...
  Future<bool> logInitiateCheckout({required String contentType,
    required String contentData,
    required String contentId,
  ...
  /// ),
  /// ```
  Future<bool> logEvent({required String eventName,
    double? valueToSum,
